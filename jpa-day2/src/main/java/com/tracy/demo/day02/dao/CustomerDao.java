package com.tracy.demo.day02.dao;
...
public interface CustomerDao extends JpaRepository<Customer,Long>, JpaSpecificationExecutor<Customer> {
    ...
    public List<Object []> findConditionSql(String name);
     ...
     *          属性名称    where custName =
     *
     *      1.findBy  +  属性名称 （根据属性名称进行完整匹配的查询）   精准匹配
